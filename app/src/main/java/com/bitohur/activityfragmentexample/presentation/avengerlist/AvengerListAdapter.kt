...
import coil.load
import com.bitohur.activityfragmentexample.databinding.ItemListAvengersBinding
import com.bitohur.activityfragmentexample.model.Person

class AvengerListAdapter(private val onItemClick: (Person) -> Unit): RecyclerView.Adapter<AvengerItemListViewHolder>() {
